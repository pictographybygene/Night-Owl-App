...
# --- HEADER ---
st.markdown("<h1 style='text-align: center; color: #bb86fc; text-shadow: 0 0 10px #bb86fc;'>🦉 NIGHT OWL</h1>", unsafe_allow_html=True)
...
with st.container():
    ...
    if mood == "Flirty":
        ...
        st.markdown("<h3 style='color: #bb86fc;'>✨ Open-Winged Owl</h3>", unsafe_allow_html=True)
    elif mood == "Exhausted":
        # ANIMATED OWL: Sleepy
        ...
        st.markdown("<h3>🌙 Sleepy Owl</h3>", unsafe_allow_html=True)
    else:
        # Standard Animated Owl (Working link)
